...
Padre_1 = str(input("Nombre y Apellido de Padre 1: "))
Padre_2 = str(input("Nombre y Apellido de Madre 2: "))
Hijo = str(input("Nombre de Hijo: "))

Nombre_1 , Apellido_1 = Padre_1.split()
Nombre_2 , Apellido_2 = Padre_2.split()
 
print("El nombre completo del hijos es:", Hijo, Apellido_1, Apellido_2)
